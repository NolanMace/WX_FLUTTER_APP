...
class DqLotteryRecordPane extends StatefulWidget {
  const DqLotteryRecordPane({super.key});

  @override
  State<DqLotteryRecordPane> createState() => _DqLotteryRecordPaneState();
}

class _DqLotteryRecordPaneState extends State<DqLotteryRecordPane> {
  final Dio _dio = Dio();

  //网络请求相关参数
  final String _getDqLotteryRecordAdmin = AppConfig.getDqLotteryRecordAdmin;
  ...
  void fetchData() async {
    try {
      ...
      Response response =
          await _dio.get(_getDqLotteryRecordAdmin, options: options);
      print(response.data);
